...
if __name__ == "__main__":
    ...
    parser.add_argument('--vsrnet_model_name', default='epochs_VSRNet/model_epoch_400.pth', type=str, help='VSRNet model name')
    parser.add_argument('--srcnn_model_name', default='epochs_SRCNN/model_epoch_800.pth', type=str, help='SRCNN model name')
    ...
    SRCNN_MODEL_NAME = opt.srcnn_model_name
    VSRNET_MODEL_NAME = opt.vsrnet_model_name
    ...
    model = Net_VSRNet(upscale_factor=UPSCALE_FACTOR, srcnn_model=SRCNN_MODEL_NAME)
    model = torch.load(VSRNET_MODEL_NAME)
...
#                cv2.waitKey(DELAY_TIME)
    ...
    h5_file_name = out_path + 'CDVL_VSRNet_test_stats.h5'
