...
dataFolder = '/home/dqq/HDData3/Data/CDVL_Processed/val/';
...
%     for fc = 1 : 5    
    ...
    %%  Save to h5 file
    buf_name = ['CDVL_Val_Data_img_df_', num2str(upscale_factor),'/HR/scene_', num2str(vid_idx), '.h5'];
    hdf5write(buf_name, '/data', buf, 'V71Dimensions', false);
    
    bufLR_Bic_name = ['CDVL_Val_Data_img_df_', num2str(upscale_factor), '/LR_Bic/scene_', num2str(vid_idx), '.h5'];
    hdf5write(bufLR_Bic_name, '/data', bufLR_Bic, 'V71Dimensions', false);
    
    bufLR_name = ['CDVL_Val_Data_img_df_', num2str(upscale_factor), '/LR/scene_', num2str(vid_idx), '.h5'];
    hdf5write(bufLR_name, '/data', bufLR, 'V71Dimensions', false);
    
    bufLR_Bic_MC_name = ['CDVL_Val_Data_img_df_', num2str(upscale_factor), '/LR_Bic_MC/scene_', num2str(vid_idx), '.h5'];
    hdf5write(bufLR_Bic_MC_name, '/data', bufLR_Bic_MC, 'V71Dimensions', false);
%     
    bufLR_MC_name = ['CDVL_Val_Data_img_df_', num2str(upscale_factor), '/LR_MC/scene_', num2str(vid_idx), '.h5'];
